...
export default function Hero() {
  ...
  const marqueeContent = marqueeSkills.map((skill, i) => (
    <span key={i} className="flex items-center gap-6 shrink-0">
      <span className="text-[#8A9AA4] text-sm font-body whitespace-nowrap">{skill}</span>
  ...
  return (
    <>
      <div className="min-h-screen flex items-center pt-20 pb-16 px-6">
        <div className="max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-[1fr_180px] gap-12 items-center">
          ...
          <motion.div variants={fadeUp} initial="hidden" animate="show">
            <div className="inline-flex items-center gap-2 bg-bg-surface px-4 py-2 rounded-full text-xs text-tx-muted mb-6">
              <span className="w-2 h-2 bg-accent-emerald rounded-full animate-pulse" />
              working + freelancing
            </div>

            {/* Typewriter heading */}
            <h1 className="font-heading font-light text-4xl md:text-5xl leading-tight mb-4">
              {lines.map((line, i) => (
            ...
            <p className="text-tx-muted text-sm leading-relaxed max-w-md mb-8 font-body font-light italic">
            ...
            <div className="flex gap-4 flex-wrap">
              ...
              <motion.button
                ...
                className="relative overflow-hidden bg-accent-emerald text-bg-primary text-sm font-body font-medium px-6 py-3 rounded-lg"
                whileHover="hover"
              >
              ...
              <a
                ...
                className="text-tx-muted text-sm font-body px-6 py-3 rounded-lg hover:text-tx-primary transition-colors"
          ...
          >
            ...
            >
              ...
              <div
                className="absolute inset-0 rounded-full border border-dashed border-accent-emerald/40 animate-spin"
                style={{
                  animationDuration: '8s',
                  boxShadow: '0 0 18px rgba(78,204,163,0.2)',
                }}
              />
              <div className="w-72 h-72 rounded-full relative overflow-hidden" style={{ border: '2px solid rgba(78,204,163,0.3)' }}>
                <img
                  src="/profile.png"
                  alt="Maheen Ghouri"
      ...
      {/* Tech marquee */}
      <div className="bg-bg-elevated py-4 overflow-hidden">
