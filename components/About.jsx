  ...
  return (
    <div ref={ref} className="py-14 md:py-20 px-4 md:px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
        ...
        <div>
          <span className="font-syne font-extrabold text-4xl md:text-6xl text-accent-emerald/20">01/</span>
          <h2 className="font-heading font-light text-2xl md:text-3xl text-tx-primary mt-1 md:mt-2 mb-6 md:mb-8">Who I Am</h2>
          ...
          <div className="flex flex-col gap-3">
            {stats.map((s, i) => (
              <motion.div
                ...
                className="bg-bg-surface rounded-xl px-4 md:px-5 py-3 md:py-4 flex justify-between items-center"
              >
        ...
        <div>
          {mobile ? (
            <motion.p
              ...
              className="text-tx-body text-xs md:text-sm leading-loose font-body font-light mb-5 md:mb-6"
            >
              {bioText}
            </motion.p>
          ) : (
            <p className="text-tx-body text-xs md:text-sm leading-loose font-body font-light mb-5 md:mb-6">
              {bioWords.map((word, i) => (
                <motion.span
                  key={i}
